import { css as H, createStitches as r1, createTheme as s1 } from "@stitches/core";
import { generateClassNames as I, VIEWS as b, template as c1, merge as W, en as i1, PREPENDED_CLASS_NAMES as a1 } from "@supabase/auth-ui-shared";
...
const g1 = H({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...v,
      style: (w = r == null ? void 0 : r.style) == null ? void 0 : w.button,
      className: E.join(" "),
      disabled: n
    },
    o,
...
function X({
  ...
  var _;
  const [E, w] = u(""), [C, d] = u(""), [a, m] = u(""), [c, y] = u(!1), x = async (h) => {
    var s;
    ...
    g ? d(g.message) : m((s = o == null ? void 0 : o.magic_link) == null ? void 0 : s.confirmation_text), y(!1);
  }, i = o == null ? void 0 : o.magic_link;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: x }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: n }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: n }, i == null ? void 0 : i.email_input_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "email",
      name: "email",
    ...
    (_ = o == null ? void 0 : o.sign_in) == null ? void 0 : _.link_text
  ), a && /* @__PURE__ */ e.createElement(S, { appearance: n }, a), C && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: n }, C)));
}
const L = H({
  width: "21px",
  height: "21px"
}), _1 = ({ provider: t }) => t == "google" ? y1() : t == "facebook" ? L1() : t == "twitter" ? b1() : t == "apple" ? p1() : t == "github" ? M1() : t == "gitlab" ? k1() : t == "bitbucket" ? S1() : t == "discord" ? N1() : t == "azure" ? F1() : t == "keycloak" ? z1() : t == "linkedin" ? H1() : t == "notion" ? B1() : t == "slack" ? D1() : t == "spotify" ? $1() : t == "twitch" ? P1() : t == "workos" ? V1() : t == "kakao" ? I1() : null, y1 = () => /* @__PURE__ */ e.createElement(
  "svg",
  {
    className: L(),
...
function A1({
  ...
  const [a, m] = u(!1), [c, y] = u(""), x = l === "vertical", i = w === "magic_link" ? "sign_in" : w, _ = async (g) => {
    m(!0);
    const { error: s } = await t.auth.signInWithOAuth({
      provider: g,
      options: {
        redirectTo: v,
        scopes: o == null ? void 0 : o[g],
        queryParams: n
      }
    });
    s && y(s.message), m(!1);
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, r && r.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: d }, /* @__PURE__ */ e.createElement(
    z,
    {
    ...
    r.map((g) => {
      ...
      return /* @__PURE__ */ e.createElement(
        ...
        x && c1(
          (s = C == null ? void 0 : C[i]) == null ? void 0 : s.social_provider_text,
          {
            provider: h(g)
          }
        )
  ...
  )), !E && /* @__PURE__ */ e.createElement(w1, { appearance: d })));
}
function Q({
  authView: t = "sign_in",
  defaultEmail: l = "",
  ...
  var T, G, Z, j;
  const x = m1(!0), [i, _] = u(l), [h, g] = u(r), [s, N] = u(""), [p, B] = u(!1), [P, U] = u("");
  R(() => (x.current = !0, _(l), g(r), () => {
    x.current = !1;
  }), [t]);
  const O = async (M) => {
    var q;
    switch (M.preventDefault(), N(""), B(!0), t) {
      case "sign_in":
      ...
      case "sign_up":
        ...
        J ? N(J.message) : n1 && !o1 && U((q = m == null ? void 0 : m.sign_up) == null ? void 0 : q.confirmation_text);
        break;
    }
    x.current && B(!1);
  }, F = (M) => {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "large", appearance: c }, /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "large", appearance: c }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: c }, f == null ? void 0 : f.email_label), /* @__PURE__ */ e.createElement(
      D,
      {
        id: "email",
        type: "email",
    ...
    )), /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "password", appearance: c }, f == null ? void 0 : f.password_label), /* @__PURE__ */ e.createElement(
      D,
      {
        id: "password",
        type: "password",
    ...
    ), w && /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "small", appearance: c }, t === b.SIGN_IN && a && /* @__PURE__ */ e.createElement(
      V,
      {
        href: "#auth-magic-link",
        onClick: (M) => {
          M.preventDefault(), o(b.MAGIC_LINK);
        },
        appearance: c
      },
      ...
      V,
      {
        ...
        onClick: (M) => {
          M.preventDefault(), o(b.FORGOTTEN_PASSWORD);
        },
        appearance: c
      },
      ...
      V,
      {
        href: "#auth-sign-in",
        onClick: (M) => {
          M.preventDefault(), F(b.SIGN_IN);
        },
        appearance: c
      },
      (j = m == null ? void 0 : m.sign_in) == null ? void 0 : j.link_text
    ))),
    P && /* @__PURE__ */ e.createElement(S, { appearance: c }, P),
    s && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: c }, s)
  );
}
function e1({
  setAuthView: t = () => {
  ...
  const [E, w] = u(""), [C, d] = u(""), [a, m] = u(""), [c, y] = u(!1), x = async (h) => {
    ...
    g ? d(g.message) : m((s = o == null ? void 0 : o.forgotten_password) == null ? void 0 : s.confirmation_text), y(!1);
  }, i = o == null ? void 0 : o.forgotten_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-forgot-password", onSubmit: x }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: n }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: n }, i == null ? void 0 : i.email_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "email",
      name: "email",
...
function t1({
  ...
  const [o, n] = u(""), [v, E] = u(""), [w, C] = u(""), [d, a] = u(!1), m = async (y) => {
    var i;
    y.preventDefault(), E(""), C(""), a(!0);
    const { error: x } = await t.auth.updateUser({ password: o });
    x ? E(x.message) : C((i = l == null ? void 0 : l.update_password) == null ? void 0 : i.confirmation_text), a(!1);
  }, c = l == null ? void 0 : l.update_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-update-password", onSubmit: m }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: r }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "password", appearance: r }, c == null ? void 0 : c.password_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "password",
      name: "password",
  ...
  ), w && /* @__PURE__ */ e.createElement(S, { appearance: r }, w), v && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: r }, v)));
}
function U1({
  setAuthView: t = () => {
  },
  ...
  var N;
  const [E, w] = u(""), [C, d] = u(""), [a, m] = u(""), [c, y] = u(""), [x, i] = u(""), [_, h] = u(!1), g = async (p) => {
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: g }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: n }, ["sms", "phone_change"].includes(r) ? /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "phone", appearance: n }, s == null ? void 0 : s.phone_input_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "phone",
      name: "phone",
  ...
  )) : /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: n }, s == null ? void 0 : s.email_input_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "email",
      name: "email",
  ...
  )), /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "token", appearance: n }, s == null ? void 0 : s.token_input_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "token",
      name: "token",
    ...
    (N = o == null ? void 0 : o.sign_in) == null ? void 0 : N.link_text
  ), x && /* @__PURE__ */ e.createElement(S, { appearance: n }, x), c && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: n }, c)));
}
const l1 = d1({ user: null, session: null }), R1 = (t) => {
  const { supabaseClient: l } = t, [r, o] = u(null), [n, v] = u((r == null ? void 0 : r.user) ?? null);
  R(() => {
    (async () => {
      var d;
      const { data: C } = await l.auth.getSession();
      o(C.session), v(((d = C.session) == null ? void 0 : d.user) ?? null);
    })();
    const { data: w } = l.auth.onAuthStateChange(
      async (C, d) => {
        o(d), v((d == null ? void 0 : d.user) ?? null);
      }
    );
    return () => {
...
function k({
  ...
  const _ = W(i1, c.variables ?? {}), [h, g] = u(v), [s, N] = u(""), [p, B] = u(""), P = h === "sign_in" || h === "sign_up" || h === "magic_link";
  R(() => {
    var F, f;
    r1({
      theme: W(
  ...
  switch (h) {
    case b.SIGN_IN:
      return /* @__PURE__ */ e.createElement(U, null, /* @__PURE__ */ e.createElement(Q, { ...O, authView: "sign_in" }));
    case b.SIGN_UP:
...
const W1 = H({
  ...
  return /* @__PURE__ */ e.createElement("div", { className: r.join(" ") }, t);
...
), Y1 = (t) => /* @__PURE__ */ e.createElement(k, { ...t, view: "magic_link", showLinks: !1 }), J1 = (t) => /* @__PURE__ */ e.createElement(
  k,
  {
    ...t,
    view: "sign_in",
...
), Q1 = (t) => /* @__PURE__ */ e.createElement(k, { showLinks: !1, ...t, view: "forgotten_password" }), X1 = (t) => /* @__PURE__ */ e.createElement(k, { ...t, view: "update_password" }), e0 = (t) => /* @__PURE__ */ e.createElement(k, { ...t, view: "verify_otp" });
export {
  k as Auth,
  j1 as AuthCard,
